...
/**
 * This class provides with the playback of the best game from 1 maze experiment against Legacy ghosts
 * @author Nikita Kuzmin
 */
public class Legacy1Maze {
    public static void main(String [] args){
        ...
        boolean visual=true;
        String fileName="results/replay2.txt";
        /*
