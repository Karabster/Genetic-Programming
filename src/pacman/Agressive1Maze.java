...
/**
 * This class provides with the playback of the best game from 1 maze experiment against Aggressive ghosts
 * @author Nikita Kuzmin
 */
public class Agressive1Maze {
    public static void main(String [] args){
        ...
        boolean visual=true;
       // String fileName = "results/replay.txt";
        String fileName="results/replay1.txt";
/*
        int bestScore = 0;
        int result = 0;
