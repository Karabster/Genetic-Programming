...
/**
 * This class provides with the playback of the best game from 4 maze experiment against Aggressive ghosts
 * @author Nikita Kuzmin
 */
public class Agressive4Maze {
    public static void main(String [] args){
        ...
        boolean visual=true;
       // String fileName="results/replay3.txt";
        String fileName = "results/replay4.txt";
/*
        int bestScore = 0;
        int result = 0;
